...
const nativeImportCertificate = app.importCertificate
app.importCertificate = (options = {}, cb) => {
  return deprecate.promisify(nativeImportCertificate.call(app, options), cb)
}
